...
| Sabrina Yang | Developed a responsive and visually appealing interface using HTML and CSS, allowing users to easily navigate through registration, profile management, and event management features. | We discussed various front-end technologies and collectively decided to utilize HTML and CSS for this project to ensure a clean, responsive, and user-friendly interface. |
